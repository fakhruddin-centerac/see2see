          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($category['tours_category_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $category['tours_category_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $category['tours_category_id']; ?>" />
                    <?php } ?></td>
