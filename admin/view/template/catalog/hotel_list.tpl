          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <?php /*echo "<pre>";print_r($visa);exit;*/ ?>
                <?php if ($hotels) { ?>
                <?php foreach ($hotels as $product) { ?>
                <tr>
                  <td class="text-center"><?php if (in_array($product['hotel_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $product['hotel_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $product['hotel_id']; ?>" />
                    <?php } ?></td>
