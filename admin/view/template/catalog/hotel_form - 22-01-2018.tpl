                                  ...
                                  <td>
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <input type="text" name="hotel_roomtype[<?php echo $roomtype_row; ?>][room_options][<?php echo $roomcount; ?>][ebd_discount]" class="form-control" value="<?php echo $rooms['discount_percentage']; ?>">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td> 
                              ...
                              <td>
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <input type="text" name="hotel_roomtype[<?php echo $roomtype_row; ?>][room_options][<?php echo $roomcalender_row; ?>][ebd_discount]" class="form-control">
                                    </td>
                                  </tr>
                                  <tr>
                                    <td> 
...
function addRoomType(){ 
  ...
  html+='</td>';
  html+='<td>';
  html+='<input type="text" name="hotel_roomtype['+ roomtype_row +'][room_options]['+roomtypecalender_row+'][ebd_discount]" class="form-control">';
  html+='</td></tr>';
...
function addCalender(roomtypeRow){  
  ...
  html +='</td><td>';
  html +='<input type="text" name="hotel_roomtype['+ roomtypeRow +'][room_options]['+ roomcalender_row +'][ebd_discount]" class="form-control">';
  html +='</td></tr>';
  html +='<tr><td>';
  html +='<label class="control-label">Adult Occupancy</label>'; 
  html +='</td><td><label class="control-label">Child Occupancy</label></td></tr>';
