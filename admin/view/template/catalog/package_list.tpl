          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <?php /*echo "<pre>";print_r($visa);exit;*/ ?>
                ...
                if($product['package_id']=="238"){?>
                <tr>
                  <td class="text-center"><?php if (in_array($product['package_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $product['package_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $product['package_id']; ?>" />
                    <?php } ?></td>
...
$('#button-filter').on('click', function() {
    var url = 'index.php?route=catalog/hotels&token=<?php echo $token; ?>';
