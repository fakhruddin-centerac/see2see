...
class ControllerCatalogParks extends Controller {
	...
	protected function getList() {
        ...
        $data['column_home'] = $this->language->get('column_home');
        $data['column_large'] = $this->language->get('column_large');
...
//echo "<pre>";print_r(	$data);exit;
	...
	protected function validateForm() {
		...
		if (utf8_strlen($this->request->post['keyword']) > 0) {
			...
			if ($url_alias_info && isset($this->request->get['parks_id']) && $url_alias_info['query'] != 'product_id=' . $this->request->get['parks_id']) {
...
//echo "<pre>";print_r($results);exit;
    ...
    public function update_home_display()
    {
        $this->load->model('catalog/parks');
        $this->model_catalog_parks->update_home_display($this->request->post);
    }
    
    public function update_show_large()
    {
        $this->load->model('catalog/parks');
        $this->model_catalog_parks->update_show_large($this->request->post);
    }
}
