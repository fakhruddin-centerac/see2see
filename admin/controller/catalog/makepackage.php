<?php
class ControllerCatalogMakePackage extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('catalog/makepackage');
...
//echo"<pre>";print_r($this->request->get);exit;
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->model_catalog_makepackage->addProduct($this->request->post);
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
          ...
          /*	echo "<pre/>";
          	print_r($this->request->post);exit;*/
			$this->model_catalog_makepackage->editProduct($this->request->get['package_id'], $this->request->post);
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $package_id) {
				$this->model_catalog_makepackage->deleteProduct($package_id);
			}
	...
	public function copy() {
		...
		if (isset($this->request->post['selected']) && $this->validateCopy()) {
			foreach ($this->request->post['selected'] as $package_id) {
				$this->model_catalog_makepackage->copyProduct($package_id);
			}
	...
	protected function getList() {
		...
		$data['add'] = $this->url->link('catalog/makepackage/add', 'token=' . $this->session->data['token'] . $url, true);
		$data['copy'] = $this->url->link('catalog/makepackage/copy', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('catalog/makepackage/delete', 'token=' . $this->session->data['token'] . $url, true);
		...
		$package_total = $this->model_catalog_makepackage->getTotalProducts($filter_data);

		$results = $this->model_catalog_makepackage->getProducts($filter_data);
		...
		foreach ($results as $result) {
			...
			$package_specials = $this->model_catalog_makepackage->getProductSpecials($result['product_id']);
			...
			$data['packages'][] = array(
				...
				'edit'       => $this->url->link('catalog/makepackage/edit', 'token=' . $this->session->data['token'] . '&package_id=' . $result['product_id'] . $url, true)
			);
		}
		...
		$this->response->setOutput($this->load->view('catalog/makepackage_list', $data));
	}
	...
	protected function getForm() {
       ...
       /* if (isset($this->request->get['filter_category_id'])) 
		...
		if (!isset($this->request->get['package_id'])) {  
			$data['action'] = $this->url->link('catalog/makepackage/add', 'token=' . $this->session->data['token'] . $url, true);
            /*custom add for url set in add case */
            /*$data['action'] = $this->url->link('catalog/makepackage/add', 'token=' . $this->session->data['token'] . '&filter_category_id=' . $this->request->get['filter_category_id'] . $url, true);*/
		} else {
          ...
          /* $data['action'] = $this->url->link('catalog/makepackage/edit', 'token=' . $this->session->data['token'] . '&package_id=' . $this->request->get['package_id']. '&filter_category_id=' . $this->request->get['filter_category_id'] . $url, true);*/
           $data['action'] = $this->url->link('catalog/makepackage/edit', 'token=' . $this->session->data['token'] . '&package_id=' . $this->request->get['package_id']. $url, true);
		...
		if (isset($this->request->get['package_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$package_info = $this->model_catalog_makepackage->getProduct($this->request->get['package_id']);
		}
		...
		if (isset($this->request->post['package_description'])) {
			...
			$data['package_description'] = $this->model_catalog_makepackage->getProductDescriptions($this->request->get['package_id']);
		} else {
		...
		if (isset($this->request->post['package_store'])) {
			...
			$data['package_store'] = $this->model_catalog_makepackage->getProductStores($this->request->get['package_id']);
		} else {
...
//echo "<pre>";print_r($visa_info);exit;
		if (isset($this->request->post['package_recurrings'])) {
			...
			$data['package_recurrings'] = $this->model_catalog_makepackage->getRecurrings($package_info['product_id']);
		} else {
...
/*		$this->load->model('catalog/package_category');
		...
		if (isset($this->request->post['package_category'])) { 
		    ...
		    $categories = $this->model_catalog_makepackage->getProductCategories($this->request->get['package_id']);
		} else {
			$categories = array();
		}*/
...
//echo "<pre>";print_r($categories);
		/*foreach ($categories as $category_id) {
			$category_info = $this->model_catalog_makepackage_category->getCategory($category_id);
		...
		$facility_data = $this->model_catalog_makepackage_facility->getCategories();
		if($facility_data){
...
//echo "<pre>";print_r($data['facility_main']);exit;
		...
		if (isset($this->request->post['package_filter'])) {
			...
			$filters = $this->model_catalog_makepackage->getProductFilters($this->request->get['package_id']);
		} else {
			$filters = array();
		}
		...
		if (isset($this->request->post['package_attribute'])) {
			...
			$package_attributes = $this->model_catalog_makepackage->getProductAttributes($this->request->get['package_id']);
		} else {
		...
		if (isset($this->request->post['package_option'])) {
            ...
            $package_options = $this->model_catalog_makepackage->getProductOptions($this->request->get['package_id']);
		} else {
		   //$package_options = $this->model_catalog_makepackage->getProductOptionsAdd(); //customcreate for particular
...
//echo "<pre>";print_r($visa_options);exit;
		...
		if (isset($this->request->post['package_discount'])) {
			...
			$package_discounts = $this->model_catalog_makepackage->getProductDiscounts($this->request->get['package_id']);
		} else {
		...
		if (isset($this->request->post['package_special'])) {
			...
			$package_specials = $this->model_catalog_makepackage->getProductSpecials($this->request->get['package_id']);
		} else {
		...
		if (isset($this->request->post['package_image'])) {
			...
			$package_images = $this->model_catalog_makepackage->getProductImages($this->request->get['package_id']);
		} else {
		...
		if (isset($this->request->post['package_download'])) {
			...
			$package_downloads = $this->model_catalog_makepackage->getProductDownloads($this->request->get['package_id']);
		} else {
		...
		if (isset($this->request->post['package_related'])) {
			...
			$related = $this->model_catalog_makepackage->getProductRelated($this->request->get['package_id']);
		} else {
			$related = array();
		}
		...
		foreach ($related as $package_id) {
			$related_info = $this->model_catalog_makepackage->getProduct($package_id);
		...
		if (isset($this->request->post['package_reward'])) {
			...
			$data['package_reward'] = $this->model_catalog_makepackage->getProductRewards($this->request->get['package_id']);
		} else {
		...
		if (isset($this->request->post['package_layout'])) {
			...
			$data['package_layout'] = $this->model_catalog_makepackage->getProductLayouts($this->request->get['package_id']);
		} else {
...
//echo "<pre>";print_r($data);exit;
		...
		$this->response->setOutput($this->load->view('catalog/makepackage_form', $data));
	}
...
//echo "<pre>";print_r($results);exit;
			foreach ($results as $result) {
				...
				$package_options = $this->model_catalog_makepackage->getProductOptions($result['product_id']);
