...
//echo "<pre>";print_r($results);exit;
    ...
    public function getoptionlistmember()
    {
        ...
        //echo "<pre>";print_r($productoptionvalues);exit;
         ...
         $json['htmladd'] = "<select class='cs-select cs-skin-border'><option value='' disabled='' selected=''>No. Of passenger</option>";
    ...
    public function getoptionlist()
    {
        ...
        if($pricetype=='private')
        {
            ...
            $json['htmladd'] = "<select class='cs-select cs-skin-border'><option value='' disabled='' selected=''>Select Minutes</option>";
                $privateoption = array();
                foreach($productoptionvalues as $optionbyprice)
                {
                    $typevalue  = $optionbyprice['time_val'];
                ...
                {
                    $json['htmladd']   .= '<option data-typetime="'.$optionset.'" >'.$optionset.'</option>';
                }
