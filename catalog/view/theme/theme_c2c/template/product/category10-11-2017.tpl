                        ...
                        <div class="book-location customfiledsairport ">
                           ...
                           <div class="">
                                <select name="typedirection" class="cs-select cs-skin-border ">
                                    ...
                                    <option value="To Airport from Hotel in Dubai">To Airport from Hotel in Dubai</option>
                                </select>
                           </div>
                           <span>
                                <i class="fa fa-calendar" aria-hidden="true"></i>
                            ...
                            <span>
                                <i class="fa fa-clock-o" aria-hidden="true"></i>
                                <input type="text" onblur="chkvaldation1(this.val)"  name="pickuptime" id="pickuplocations" class="pick-up-location" placeholder="Please Enter Pickup Time 2:00 PM"/>
                            </span> 
                        </div>
                        <?php 
                        }
