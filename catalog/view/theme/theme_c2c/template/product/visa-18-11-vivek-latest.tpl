                                ...
                                <div class="col-sm-12">
                                  ...
                                  <div class="row">
                                   ...
                                   <div class="visa-select-drop visa-select residence_countryy_select personresidevisa mandatory">
                                      ...
                                      <select  name="applicantinfo[0][residence]" class="cs-select cs-skin-border country_select" rel="0">
                                    ...
                                    <div class="col-sm-4">
                                      <div class="visa-select-drop visa-select countryy_select personcountryvisa mandatory orignalcountry">
                                         <select  name="applicantinfo[0][country]" id="orignalcountry"  class="cs-select cs-skin-border " rel="0">
