                        ...
                        <div class="item-book-now">
                            ...
                            <div class="myboxforprivate hide">
                                <div class="cs-select cs-skin-border" tabindex="0">
                                    <span class="cs-placeholder">Transfer Rates</span>
                                    <div class="cs-options">
                                        <ul>
                                            <?php 
                                            if($options)
...
$('#button-cart').on('click', function() {
    $.ajax({
		...
		type: 'post',
		data: $('#product input[type=\'text\'], #product input[type=\'hidden\'], #product input[type=\'radio\']:checked, #product input[type=\'checkbox\']:checked, #product select, #product textarea,.parenthidprice,.childhidprice,.cusproductoptionvalueid,#datepicker,#pickuplocations,.top_up'),
		dataType: 'json',
		beforeSend: function() {
