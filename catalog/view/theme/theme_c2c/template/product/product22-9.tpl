                    ...
                    <div class="col-sm-4">
                        <div class="item-book-now">
                                                ...
                                                foreach($options as $optionmy)
                                                {
                                                    if($optionmy['required']==1)
                                                    {
                                                       ...
                                                       else
                                                       {
                                                            ...
                                                            $attr = 'data-product-option-id="'.$optionmy['product_option_id'].'" data-option-id="'.$optionmy['option_id'].'" data-type="'.$optionmy['name'].'" onclick="mycalculationsprivateparent('.$optionmy['option_id'].')" ';
                                                       }   
                                                    }    
                                             ?>
                            ...
                            <div class="book-location">
                                <span><input type="text" onblur="chkvaldation(this.val)" name="tourdate" id="datepicker" class="choose-location-book" placeholder="Date"></span>
                                <span><input type="text" onblur="chkvaldation(this.val)"  name="pickuplocation" id="pickuplocations" class="pick-up-location" placeholder="Pickup Location"></span>
                            </div>
                            <div class="book-total">Total : AED - 0</div>
