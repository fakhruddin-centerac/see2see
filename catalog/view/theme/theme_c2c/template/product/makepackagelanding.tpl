    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 hotel-form-main search-hotel-main">
                <form class="home-hotel-form" name="hotel-search" id="hotel-search" action="<?php echo 'index.php?route=product/makepackage/hotels'; ?>" method="post" data-toggle="validator" role="form">
                    <h2>SEARCH FOR HOTEL</h2>

                    <div class="hotel-form-section">
                        <div class="row">
                            <div class="col-sm-6">                                
                                <select name="filter_nationality" id="nationality" required>
                        ...
                        <div class="row">
                            <!-- <div class="col-sm-6 col-md-2">                                
                                <div class="hotel-check-star">
                                    <input type="checkbox" name="filter_quantity[]" value="3"  <?php if($filter_star =='3'){ echo 'checked'; } ?> />
                                ...
                                <div class="hotel-check-star">
                                    <input type="checkbox" name="filter_quantity[]" value="4" <?php if($filter_star =='4'){ echo 'checked'; } ?> />
                                ...
                                <div class="hotel-check-star">
                                    <input type="checkbox" name="filter_quantity[]" value="5" <?php if($filter_star =='5'){ echo 'checked'; } ?> />
                            ...
                            <div class="col-sm-12 col-md-7 pad-l-5">
