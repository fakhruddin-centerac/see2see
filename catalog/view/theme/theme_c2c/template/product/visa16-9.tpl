                ...
                <div class="page-title review-title">
                  <h1>
                    <div class="page-pagination">
                        ...
                        <span  role="presentation" ><a href="#visa-2" aria-controls="visa-1" role="tab" data-toggle="tab">2</a></span>
                    </div>
                    <span>14 Days Tourist Visa</span>    
                    </h1>
              ...
              <div class="tab-content">
                <div role="tabpanel" class="tab-pane fade in active" id="visa-1">
                  ...
                  <div class="row visa-item">
                    <div class="col-sm-12">
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="visa-select-drop visa-select">
                           <select class="cs-select cs-skin-border">
                              <option value="" disabled selected>UAE RESIDENT  </option>
                              <option value="email">NON UAE RESIDENT (WITH UAE REFERENCE)</option>
                              <option value="twitter">NON UAE RESIDENT (WITHOUT UAE REFERENCE)</option>
                          </select>
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="select-drop visa-select">
                           <select class="cs-select cs-skin-border">
                              <option value="" disabled selected>Number oof Applicants Travelling</option>
                              <option value="email">2</option>
                              <option value="twitter">3</option>
                          </select>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="row visa-item">
                    <div class="col-sm-12">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-4">
                          <div class="select-drop">
                           <input type="text" placeholder="Country of Residence" class="review-input">
                          </div>
                        </div>
                        <div class="col-sm-4">
                          <div class="visa-select-drop visa-select">
                             <select class="cs-select cs-skin-border ">
                                ...
                                <option value="email">INDIA</option>
                                <option value="twitter">UAE</option>
                            </select>
                            </div>
                        </div>
                        <div class="col-sm-4">
                          <div class="select-drop date-birth-visa">
                           <input type="text" placeholder="Date of Birth" class="review-input">
                          </div>
                        </div>
                        <div class="col-sm-4">
                          <div class="visa-select-drop visa-select">
                             <select class="cs-select cs-skin-border ">
                                ...
                                <option value="twitter">Female</option>
                            </select>
                            </div>
                        </div>
                      </div>
                ...
                <div class="col-sm-12">
                  <div class="review-action visa-action">
                    <span class="action-title-visa">Total - AED : 950</span>
                ...
                <div class="dark-block review-block">
                  <div class="row">
                    ...
                    <div class="col-sm-4">
                      <input type="text" placeholder="Qualification" class="review-input">
                    </div>
                    <div class="col-sm-4">
                      <div class="file-wrap">
                        <div class="c2c-file-upload">
                    ...
                    <div class="col-sm-4">
                      <input type="text" placeholder="Traveller's Email ID" class="review-input">
                    </div>
                    <div class="col-sm-4">
                      <div class="travl-mob">
                        <div class="apli-sub">Traveller's Mobile No.*</div>
                        <input type="text" placeholder="Code" class="review-input">
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <input type="text" placeholder="Mob NO" class="review-input mob-visa">
                    </div>
                  </div>
                </div>
                <div class="review-block visa-main">
...
function mycalculationscombo(optionid)
{
   ...
   /*this function is for only SIC ANd Without transfer*/
     ...
     $(".myboxescalculations").html(html+'<div class="book-pick"><span>No of Adults</span><span><input value="" onblur="priceadult(this.value,price)"  name="adultnumbers" type="text" placeholder="00"></span><span>No of Childrens</span><span><input value="" onblur="pricechild(this.value,childprice)" name="childumbers"  type="text" placeholder="00"></span></div>');      
