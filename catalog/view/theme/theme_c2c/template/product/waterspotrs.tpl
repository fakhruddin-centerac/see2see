...
<div class="section item-section watersportspage">
        <div class="container">
            <div class="section-list section-list-inner ">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="item-book-now">
                            <h2>BOOK NOW</h2>
                            <div class="item-book-drop12">
                                <!--<select name="typeoftranswer" class="cs-select cs-skin-border">
                                    <?php
                                        if($options)
                                            {
                                                foreach($options as $optionmy)
                                                {
                                                    ...
                                                    {
                                                        $attr = 'data-price_type="'.$optionmy['price_type'].'" data-product-option-value-id="'.$optionmy['product_option_value'][0]['product_option_value_id'].'"  data-product-option-id="'.$optionmy['product_option_id'].'" data-childprice="'.$optionmy['product_option_value'][0]['child_price'].'" data-option-id="'.$optionmy['option_id'].'" data-price="'.$optionmy['product_option_value'][0]['orignalprice'].'" data-type="'.$optionmy['name'].'" '; 
                                                    ?>
                                                        <option <?php echo $attr; ?>><?php echo $optionmy['name']; ?></option>
                                                    <?php
                                                    }
                                                 }
                                             }       
                            ...
                            <div class="item-book-drop myfirstsectlcusitem">
                                            ...
                                            if($options)
                                            {
                                                foreach($options as $optionmy)
                                                {
                                                    if($optionmy['required']==1)
                                                    {
                                                       ...
                                                       {
                                                            //price type with_transfer,sic,private 
                                                            //'.$optionmy['product_option_value'][0]['price'].'  '.$optionmy['name'].',
                                                            $attr = 'data-price_type="'.$optionmy['product_option_value'][0]['price_type'].'"  data-product-option-value-id="'.$optionmy['product_option_value'][0]['product_option_value_id'].'"  data-product-option-id="'.$optionmy['product_option_id'].'" data-childprice="'.$optionmy['product_option_value'][0]['child_price'].'" data-option-id="'.$optionmy['option_id'].'" data-price="'.$optionmy['product_option_value'][0]['orignalprice'].'" data-type="'.$optionmy['name'].'" onclick="mycalculationscombo('.$optionmy['option_id'].')" ';
                                                       }
                                                       else
                                                       {
                                                            ...
                                                            //$attr = 'data-price_type="'.$optionmy['product_option_value'][0]['price_type'].'"  data-product-option-id="'.$optionmy['product_option_id'].'" data-option-id="'.$optionmy['option_id'].'" data-type="'.$optionmy['name'].'" onclick="mycalculationsprivateparent('.$optionmy['option_id'].')" ';
                                                            $attr = 'data-price_type="'.$optionmy['product_option_value'][0]['price_type'].'"  data-product-option-value-id="'.$optionmy['product_option_value'][0]['product_option_value_id'].'"  data-product-option-id="'.$optionmy['product_option_id'].'" data-childprice="'.$optionmy['product_option_value'][0]['child_price'].'" data-option-id="'.$optionmy['option_id'].'" data-price="'.$optionmy['product_option_value'][0]['orignalprice'].'" data-type="'.$optionmy['name'].'" onclick="mycalculationscombo('.$optionmy['option_id'].')" ';
                                                       }   
                                                    }    
                                             ?>
                            ...
                            <div class="myboxforprivate hide">
                                <div class="cs-select cs-skin-border" tabindex="0">
                                    <span class="cs-placeholder">Private</span>
                                    <div class="cs-options">
                                        <ul>
                                            <?php 
                                            if($options)
                                            {
                                                foreach($options as $optionmy1)
                                                {
                                                    if($optionmy1['name']=='Private' && $optionmy1['required']==1)
                                                    {    
                                                        foreach($optionmy1['product_option_value'] as $optionprivate)
                                                        {
                                                  ...
                                                  ?>
                                                  <?php ?><li <?php echo $attr; ?> ><span><?php echo $optionprivate['name']; ?></span></li>
                                                  <?php          
                                                        }
                                                    }
                                                }
                            ...
                            <div class="book-location ">
                               <span class="hide numberofpag">
                                    <i class="fa fa-user-circle-o" aria-hidden="true"></i>
                                    <input type="text" onblur="chkvaldation(this.val)" name="numberofpassenger" class="numberofpassenger_pax"  placeholder="Enter Number of Passenger"/>
                                </span>
                                <span>
                            ...
                            <div class="transfer_rate hide">
                                <div class="book-rate">
                                    ...
                                    <span class="transferprice">AED 0</span>
                            ...
                            <div class="book-total"> 
                             <div class="book-rate">
                                    <span>Total : </span>
                                    <span class="book-total-price">AED 0</span>
              ...
              <div class="col-sm-12">
                <div class="page-title review-title">
                  <h1><span>WRITE YOUR REVIEW</span></h1>
                </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-8">
                      <div class="review-rating">
                        <span>Rating</span>
                        <img src="catalog/view/theme/theme_c2c/images/rating.png">
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <input type="text" placeholder="Summary" class="review-input">
                    </div>
                    <div class="col-sm-4">
                      <input type="text" placeholder="Name" class="review-input">
                    </div>
                    <div class="col-sm-4">
                      <input type="email" placeholder="Email" class="review-input">
                    </div>
                    <div class="col-sm-12">
...
<!--
transfer_rate,transferprice -->

<script type="text/javascript"><!--
        
        /*defalut call function mycalculationscombo(14) for without transfer */
        
        /*gloablavariable to find all filed are validate or not when all fileds are validate then */
        validateflag = '';//make this variable to 1 when all are valiadte and when swich the agin se to blank;
...
function chkvaldation(val)
{
    ...
    /*flag for no of passanger*/
    noofpagflag = '';
    if($('.numberofpag').hasClass('mandory'))
    {
        noofpagflag = $('.numberofpag.mandory input[name=numberofpassenger]').val();
    }
    else
    {
        noofpagflag = 1;
    ...
    if(n_adultnumbers>0)
    {
        ...
        {
            if(datepicker_chk!='' && pickuplocations_chk!='' && noofpagflag!='')
            {
...
function mycalculationsprivateparent(optionid)
{
    //price type with_transfer,sic,private 
...
function mycalculationscombo(optionid)
{
   ...
   /*this function is for only SIC ANd Without transfer*/
     ...
     data_price_type           = $('.myfirstsectlcus .cs-options ul li[data-option-id='+optionid+']').attr('data-price_type');
     
    // alert(data_price_type);
     
     /*
     if(data_price_type=='with_transfer')
       {
         $(".showNopax").remove();
       }
     */
     if(data_price_type=='with_transfer')
       {
          latest_data_price_type="without_transfer";
       }
      else
      {
        latest_data_price_type=data_price_type;
      } 
     $(".travel_type").val(latest_data_price_type);
     
     /*reove html of timetype,membertype*/
     $('.timetype').html('');
     $('.membertype').html('');
     
     $(".setcalprice").hide();
     $(".adultpricetotal").html('');
    ...
    //alert(data_price_type);
     /*need to call ajax*/
      $.ajax({
				method: "POST",
                url: 'index.php?route=product/product/getoptionlist',
				dataType: 'json',
                data: {"pricetype":data_price_type,"productid":<?php echo $product_id; ?> ,},
				success: function(json) 
                {   
                    
                    $('.timetype').html(json['htmladd']);
                    $('.timetype').addClass('martop-15');
                    
                    if(json['pricetype']=='private')
                    {
                           if($('.numberofpag').hasClass('hide')){ }
                           else{ $('.numberofpag').addClass('hide');$('.numberofpag').removeClass('mandory'); }
                           (function() {
                            [].slice.call( document.querySelectorAll( '.timetype select.cs-select' ) ).forEach( function(el) {  
                              new SelectFx(el,{
                              onChange: function(val) {
                                   data_typetime = $('.timetype select option:selected').attr('data-typetime');
                                    $.ajax({
                        				method: "POST",
                                        url: 'index.php?route=product/product/getoptionlistmember',
                        				dataType: 'json',
                                        data: {"timetype":data_typetime,"productid":<?php echo $product_id; ?>,},
                        				success: function(json) 
                                        {
                                           
                                           var string =  '<div class="book-location showNopax"><span class="numberofpag"><i class="fa fa-user-circle-o" aria-hidden="true"></i><input type="text" onblur="priceadult(this.val)" name="numberofpassenger" placeholder="Enter Number of Passenger" class="numberofpassenger"/> </span></div>';
                                             $('.membertype').html(string+''+json['htmladd']);
                                             $('.membertype').addClass('martop-15');
                                           //$('.timetype').html(json['htmladd']);
                                                (function() {
                                                [].slice.call( document.querySelectorAll( '.membertype select.cs-select' ) ).forEach( function(el) {  
                                                  new SelectFx(el,{
                                                  onChange: function(val) 
                                                  {
                                                    
                                                     data_product_option_id = $('.membertype select option:selected').attr('data-product-option-id');
                                                     data_product_option_value_id = $('.membertype select option:selected').attr('data-product-option-value-id');
                                                     data_price = $('.membertype select option:selected').attr('data-price');
                                                     //alert("option["+data_product_option_id+"]= "+data_product_option_value_id);
                                                     optioninput  ='';
                                                     $('.otpinhidvaluehere').html(optioninput);
                                                     optioninput  ='<input type="hidden" class="cusproductoptionvalueid" name="option['+data_product_option_id+']" value="'+data_product_option_value_id+'" />';
                                                     $('.otpinhidvaluehere').html(optioninput);
                                                     totaltranfer_price = 'AED '+data_price;
                                                     $(".transfer_rate").removeClass('hide'); 
                                                     $(".transfer_rate").show()
                                                     $(".transferprice").text(totaltranfer_price)
                                                      val =   $(".numberofpassenger").val();
                                                      data_typetime = $('.timetype select option:selected').attr('data-data-price-charge');
                                                      total_price   = parseInt(data_typetime * val) + parseInt(data_price);
                                                      
                                                     $('.book-total-price').text(" AED "+ total_price);
                                                  }
                                                });
                                              });
                                              })();
                    ...
                    else
                    {
                        //$('.timetype').html(json['htmladd']);
                        /*show numberof user*/
                        $('.numberofpag').removeClass('hide');
                        $('.numberofpag').addClass('mandory');
                        $('.book-total-price').text('AED 0');
                        ...
                        [].slice.call( document.querySelectorAll( 'select.cs-select' ) ).forEach( function(el) {  
                          ...
                          onChange: function(val) {
                             ...
                             data_product_option_id       = $('.timetype select option:selected').attr('data-product-option-id');
                             data_product_option_value_id = $('.timetype select option:selected').attr('data-product-option-value-id');
                             data_price                   = $('.timetype select option:selected').attr('data-price');
                             //alert("option["+data_product_option_id+"]= "+data_product_option_value_id);
                             optioninput  = '';
                             $('.otpinhidvaluehere').html(optioninput);
                             optioninput  ='<input type="hidden" class="cusproductoptionvalueid" name="option['+data_product_option_id+']" value="'+data_product_option_value_id+'" />';
                             $('.otpinhidvaluehere').html(optioninput);
                             totalsumtext = 'AED '+data_price; 
                              //$('.book-total').text(totalsumtext);
                             // $('.book-total-price').text(totalsumtext);
                             /*need to check date localtion for this we call chkvaldation function and pass any parameter because paramer is not used in this function*/
                             chkvaldation(1);
                            }
                        });
                      });
...
$(".numberofpassenger_pax").blur(function(){
    
    val =   $(this).val();
    
    data_type_price = $('.timetype select option:selected').attr('data-price');
 
     total_price   = data_type_price * val;
     $(".book-total-price").html("AED "+total_price);
    $(".parenthidprice").val(val);
    $(".childhidprice").val(0);
})
function priceperson()
 {
      ...
      if(data_price==undefined)
       {
        total_price   = data_typetime * val;
         adultpricetotal = data_typetime * val;
       }
      else 
        {
             total_price   = parseInt(data_typetime * val)+ parseInt(data_price);
      ...
      $(".setcalprice").removeClass('hide'); 
      $(".setcalprice").show();
      $(".adultpricetotal").html("AED "+adultpricetotal);
      $(".parenthidprice").val(val);
      $(".childhidprice").val(0);
      $(".book-total-price").html("AED "+total_price);
