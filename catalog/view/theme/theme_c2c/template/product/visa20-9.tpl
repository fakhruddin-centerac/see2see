...
function addapplicanbut()
{
    ...
    html  ='<div class="review-block visa-main applicantno-'+applcannumber+'"><div class="row visa-item"><div class="col-sm-12"><div class="visa-title"><h3>Applicant no '+ applcannumberplusone +'</h3></div><div class="row"><div class="col-sm-4"><div class="select-drop mandatory">';
    ...
    for(ilopp=1; ilopp<loopcontroller;ilopp++)
    {
        ...
        if(typeofregident=='UAE RESIDENT' || typeofregident=='NON UAE RESIDENT (WITH UAE REFERENCE)')
        {
            ...
            var restrict_country_limited = ["18","156","144","162"];
             ...
             if(checklimitedHas==-1)
             {
                  /*thgis is under no condional country*/
        ...
        applhtml +='</div><div class="col-sm-4"><div class="file-wrap"><div class="c2c-file-upload '+qualitycertificationmandatorycls+' ">';
        ...
        applhtml +='<img src="catalog/view/theme/theme_c2c/images/attachmnt-icon.svg"/></div><div class="file-text">Proof of Exit Stamp from the UAE</div></div></div><div class="col-sm-4 mandatory">';
        ...
        */
        ...
        applhtml +='</div>';
        $('#visa-2 .allapendadapplcant').html(applhtml);
        (function() {
