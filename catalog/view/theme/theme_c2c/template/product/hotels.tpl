                    ...
                    <div class="hotel-result-container">
                        <div class="hotel-search-box">
                            ...
                            <div class="hotel-info">
                                <h2><a href="<?php echo 'index.php?route=product/hotels/hoteldetails&hotel_id='.$hotel_id.'&filter='.$filter_nationality.'&filter_sku='.$filter_sku.'&people_count='.$total_people.'&checkin='.$filter_checkin.'&checkout='.$filter_checkout.'&rooms='.$filter_rooms.'&adult='.$filter_adult.'&child='.$filter_child.'&visa_option='.$filter_visa; ?>"><?php echo $hotel['name']; ?></a></h2>
