                        ...
                        <div class="item-book-now">
                                        ...
                                        <ul> 
                                            ...
                                            if($options)
                                            {
                                                foreach($options as $optionmy1)
                                                {
                                                  ...
                                                  ?> 
                                                 <li <?php echo $attr; ?> ><span> <?php echo $optionprivate['name']; ?></span></li>
                                                  <?php          
                                                        }
                                                    }
                                                }
                            ...
                            <div class="book-location">
                                <span class="hide numberofpag">
                                    ...
                                    <input type="text" onblur="chkvaldation(this.val)" name="numberofpassenger" placeholder="Enter Number of Passenger"/>
                                </span>
                                <span>
                            ...
                            <div class="book-total"> AED 0 </div>
    ...
    if(n_adultnumbers>0)
    {
        ...
        if(chk_adultnumbers!=0 || chk_childumbers!=0 )
        {
            if(datepicker_chk!='' && pickuplocations_chk!='' )
            {
                ...
                else{$('#button-cart').prop('disabled', false);}
