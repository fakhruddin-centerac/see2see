                ...
                <div class="col-sm-4">
                    <div class="item-book-now">
                        ...
                        <div class="item-book-drop">
                            ...
                            <input type="hidden" name="transfer_charges" value="0" class="transfer_charges"/>
                                                ...
                                                foreach($options as $optionmy)
                                                {
                                                    if($optionmy['required']==1)
                                                    {
                                                       ...
                                                       {                                                            
                                                            ...
                                                            $attr = 'data-product-option-value-id="'.$optionmy['product_option_value'][0]['product_option_value_id'].'"  data-product-option-id="'.$optionmy['product_option_id'].'" data-childprice="'.preg_replace( '/[^.\d]/', '', $optionmy['product_option_value'][0]['child_price']).'" data-option-id="'.$optionmy['option_id'].'" data-price="'.preg_replace( '/[^.\d]/', '', $optionmy['product_option_value'][0]['orignalprice']).'" data-type="'.$optionmy['name'].'" onclick="mycalculationscombo('.$optionmy['option_id'].')" ';
                                                       }
                                                       else
                                                       {
                                                        
                                                        
                                                            $attr = 'data-childprice="'.preg_replace( '/[^.\d]/', '', $optionmy['product_option_value'][0]['top_up_child']).'" data-price="'.preg_replace( '/[^.\d]/', '', $optionmy['product_option_value'][0]['top_up_adults']).'"  data-product-option-id="'.$optionmy['product_option_id'].'" data-option-id="'.$optionmy['option_id'].'" data-type="'.$optionmy['name'].'" onclick="mycalculationsprivateparent('.$optionmy['option_id'].')" '.$price;
                                                       }   
                                                    }    
                                             ?>
                                        <li
                                        <?php echo $attr; ?> ><span><?php echo $optionmy['name']; ?></span></li>
                                        <?php
                                            ...
                                            if($options)
                                            {
                                                foreach($options as $optionmy)
                                                {
                                                    ...
                                                    {    
                                                        ...
                                                        {
                                                            $attr = 'data-product-option-value-id="'.$optionprivate['product_option_value_id'].'"   data-product-option-id="'.$optionmy['product_option_id'].'" data-price="'.preg_replace( '/[^.\d]/', '', $optionprivate['orignalprice']).'" data-option-value-id="'.$optionprivate['option_value_id'].'" onclick="mycalculationprivate('.$optionprivate['option_value_id'].')"  ';
                                                        
                                                  ?>
                                        <?php ?>
                                        <li
                                        <?php echo $attr; ?> ><span><?php echo $optionprivate['name']; ?>
                                            Passengers</span></li>
                                        <?php
                                                        }
                                                    }
                        ...
                        <div class="book-location">
                                <span>
                                    ...
                                    <input type="text" onblur="chkvaldation(this.val)" name="tourdate" id="datepicker"
                                           class="choose-location-book" placeholder="Date"></span>
                                <span class="pickup">
                                    <i class="fa fa-map-marker" aria-hidden="true"></i>
                                    <input type="text" onblur="chkvaldation(this.val)" name="pickuplocation"
                                           id="pickuplocations" class="pick-up-location" placeholder="Pickup Location">
                                </span>
                        </div>
                        ...
                        <div class="book-total book-rate"><span>Total: </span> <span><?php echo $currencysymbol; ?>
                                0 </span></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <div class="review-rating">
                                        <h2><?php echo $entry_rating; ?></h2>


                                                <span class="star-cb-group clearfix">
                                ...
                                <div class="col-sm-12">
                                    <input value="<?php echo $summary; ?>" name="summary" type="text"
                                           placeholder="Your experience in a word" class="review-input"/>
                                </div>

                                <div class="col-sm-6">
                                    <input class="review-input" type="text" placeholder="Name" name="name"
                                           value="<?php echo $customer_name; ?>" id="input-name"/>
                                </div>
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-12">
                                    <div class="review-action">
                                        <button type="button" id="button-review"
                                                ...
                                                class="btn btn-primary">SUBMIT<?php //echo $button_continue; ?></button>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="review-info">
                                        ...
                                        After you click &laquo;Submit&raquo; your review will be entered into our
                                        database for final approval before it is posted live to the public. We will edit
                                        only to address inappropriate or offensive content.
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="owl-carousel owl-theme related-items">
                        ...
                        <div class="item">
                            <div class="sec-list-wrap">
                                <div class="list-item-img"><img src="<?php echo $product['thumb']; ?>"
                                ...
                                <div class="list-item-dsc">
                                    ...
                                    <div class="list-item-action">
                                        ...
                                        <span class="lsit-item-more"><a href="<?php echo $product['href']; ?>">KNOW
                                                MORE</a></span>
                                    </div>
                                </div>
                            </div>
    ...
    function chkvaldation(val) {
        ...
        if (n_adultnumbers > 0) {
            ...
            if (chk_adultnumbers != 0 || chk_childumbers != 0) {
                ...
                var transferMethod = $('.myfirstsectlcus .cs-placeholder').eq(0).text();

                if (transferMethod == 'Private' || transferMethod == 'SIC') {
                ...
                } else if (transferMethod == 'Without Transfer') {
...
<script type="text/javascript"><!--
    ...
    function mycalculationsprivateparent(optionid) //771
    {
        ...
        if (top_up == 1) {
            ...
            html = '<div class="book-rate"><span>Adult: </span><span class="adultpricetotal">' + CURRENCY_SYMBOL + '  0</span><span>Children:</span><span class="childpricetotal">' + CURRENCY_SYMBOL + ' 0</span></div>';
            $('.setcalprice').removeClass('hide');
        ...
        $('.myboxforprivate .cs-options ul li').each(function (e) {
            $(this).removeAttr('class')
        });
        $('.myboxforprivate .cs-placeholder').html('Transfer Rates');
    ...
    function mycalculationprivate(optionidprivate) {
        ...
        if (top_up == 1) {
            ...
            $(".transferprice").html(CURRENCY_SYMBOL + ' ' + parseFloat(privateprice));
            $(".transfer_charges").val(parseFloat(privateprice));
    ...
    function priceadult(val, priceadult) {
        ...
        transfercharges = $('input[name="transfer_charges"]').val();
        totalpricesum = parseFloat(adultprice) + parseFloat(childpriceget) + parseFloat(transfercharges);
    ...
    function pricechild(val, pricechild) {
        ...
        transfercharges = $('input[name="transfer_charges"]').val();
        totalpricesum = parseFloat(adultpriceget) + parseFloat(childpriceval) + parseFloat(transfercharges);
        totalsumtext = " Total: " + CURRENCY_SYMBOL + " " + totalpricesum;
        $('.book-total').text(totalsumtext);
        /*parenthidprice-childhidprice*/
        ...
        if (transferMethod == 'Private') {
            var transferRate = $('.myboxforprivate .cs-placeholder').eq(0).text();
            if (datepicker_chk != '' && pickuplocations_chk != '' && transferRate != '') {
                $('#button-cart').prop('disabled', false);
            } else {
                $('#button-cart').prop('disabled', true);
            }
