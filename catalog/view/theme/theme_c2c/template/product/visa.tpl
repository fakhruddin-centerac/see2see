...
<div class="container">
    <ul class="breadcrumb">
        ...
        <!--<li><a href="<?php  $breadcrumb['href']; ?>"><?php echo $breadcrumb['text']; ?></a></li>-->
        <li><a href="javascript:void(0)"><?php echo $breadcrumb['text']; ?></a></li>
        <?php } */
          
        
        foreach ($breadcrumbs as $breadcrumb) {
             if($breadcrumb['text']!='Visa Category')
              {?>
                                ...
                                <div class="col-sm-12">
                                  ...
                                  <div class="row">
                                   ...
                                   <div class="visa-select-drop visa-select residence_countryy_select personresidevisa mandatory">
                                      ...
                                      <select  name="applicantinfo[0][residence]" class="cs-skin-border country_select" rel="0">
                                    ...
                                    <div class="col-sm-4">
                                      <div class="visa-select-drop visa-select countryy_select personcountryvisa mandatory orignalcountry">
                                         <select  name="applicantinfo[0][country]" id="orignalcountry"  class="cs-skin-border country_select " rel="0">
                                ...
                                <div class="dark-block review-block">
                                    <div class="row">
                                        ...
                                        if($country_flag!='LIMITED')
                                         {?>
                                           <div class="col-sm-4 marriage_certificate">
                                            <div class="file-wrap">
                                                <div class="c2c-file-upload ">
...
function addapplicanbut(Iid)
{
   ...
   // html +='<input type="text" name="applicantinfo['+applcannumber+'][residence]" placeholder="Country of Residence" class="review-input applicantinfo-'+applcannumber+'-residence"/>';
    ...
    $newElement_select ='<select name="applicantinfo['+applcannumber+'][residence]" class="cs-skin-border country_select applicantinfo-'+applcannumber+'-residence " rel='+applcannumber+'  >'; 
    ...
    $newElement ='<select name="applicantinfo['+applcannumber+'][country]" class="cs-skin-border country_select applicantinfo-'+applcannumber+'-country " rel='+applcannumber+'  >'; 
 ...
 /*
   if(notOther==null || notOther=='Relationship with primary applicant')
    ...
    ///adding select 2 dropdown plugin
    setTimeout(function(){ $('.country_select').select2(); }, 100);
  ...
  onChange: function(val) {  
    ...
    if(counyrymainsel!=null)
    {
        console.log('main country:'+counyrymainsel);
        console.log('original country');
...
function checkcunrtybound(country_selectsing,banglaVar)
{
 ...
 function nextTab(elem) 
 {
     ...
     /*hideonmorethanone*/
      ...
      if($('.personrelationshipvisa .cs-placeholder').length == 1)
       ...
       var typeofregident = $('.typeofresidentapplicant select').val();
             ...
             if(relationtype=='Other' && typeofregident!='NON UAE RESIDENT (WITHOUT UAE REFERENCE)')
             {
    ...
    /*if UAE RESIDENT  or NON UAE RESIDENT (WITH UAE REFERENCE) then this block appear*/
      ...
      { 
          ...
          for(ilopp=1; ilopp<loopcontroller;ilopp++){
            var relationship      = $('.applicantinfo-'+ilopp+'-relationship').siblings('.cs-placeholder').text();
              if(relationship =="Other" || relationship=="Spouse"){
                  htmltype ='<div class="visaholderblock"><div class="dark-block review-block"><div class="row visa-item"><div class="col-sm-12"><div class="visa-title"><h3>Provide the following documents and information of the UAE Residence VISA holder</h3></div><div class="row"><div class="col-sm-6"><div class="file-wrap"><div class="c2c-file-upload mandatory">';
                  htmltype +='<input name="uaeresidencevisaholder[passportfrent]" type="file"/>';
                  htmltype +='<img src="catalog/view/theme/theme_c2c/images/attachmnt-icon.svg"/></div><div class="file-text">Passport Copy (First Page)*</div></div></div><div class="col-sm-6"><div class="file-wrap"><div class="c2c-file-upload mandatory">';
                  htmltype +='<input name="uaeresidencevisaholder[passportback]" type="file">';
    ...
    /* here we need to genrate 4 condition like document */
    hotelreservationmandatorycls ='';
        ...
        {
            /*now you are in 3rd option*/
              /*now check  for # condion with **double star  */
              var country_flag = $('input[name="country_flag"]').val();    
              if(country_flag=='LIMITED')
              {
                  /*this is for 14, 30 days pakage*/
                  console.log('inside 14 and 30 days package'); 
                  console.log('realtion type:'+relationtype);
                  if(typeofregident=='NON UAE RESIDENT (WITHOUT UAE REFERENCE)' && (relationtype=='Other' || relationtype=='Relationship with UAE resident applicant')){
                    console.log('adding hotel reservation for non uae - latest vivek');
                     $('.applicantinfomation-0 .hotelreservation').removeClass('hide');
                     $('.applicantinfomation-0 .hotelreservation').addClass('show');
                  }
              ...
              else
              {
                    ...
                    console.log('inside 90 days package');
                    $('.hotelreservation').addClass('hide');
              }    
        }
    ...
    console.log('conditional county flag:'+conditionalcountry_flagsinng);
    if(relationtype=='Other' || conditionalcountry_flagsinng==1)
    {
         console.log('inside other 1');
         htmlcertifiate  ='';
         ...
         */
         console.log('last change made- vivek');
         $('.applicantinfomation-0 .qualificationofapplicant').after(htmlcertifiate); 
         console.log('added qualification- vivek');  
    }
  
  if((conditionalcountry_flagsinng==1) && (typeofregident=='NON UAE RESIDENT (WITHOUT UAE REFERENCE)')) 
   {
      console.log('inside my condition');
      $(".qualificationcertificatecls").remove();
      $(".exitstampcls").remove();
      htmlcertifiate  ='';
      htmlcertifiate +='<div class="col-sm-4 qualificationcertificatecls fgg"><div class="file-wrap"><div class="c2c-file-upload mandatory '+qualitycertificationmandatorycls+' ">';
      htmlcertifiate +='<input name="applicantinfo[0][qualificationcertificate]" type="file" />';
      htmlcertifiate +='<img src="catalog/view/theme/theme_c2c/images/attachmnt-icon.svg"/></div><div class="file-text">Qualification Certificate</div></div></div>';
      htmlcertifiate += '<div class="col-sm-4 exitstampcls"><div class="file-wrap"><div class="c2c-file-upload mandatory"><input name="applicantinfo[0][exitstamp]" type="file"><img src="catalog/view/theme/theme_c2c/images/attachmnt-icon.svg"></div><div class="file-text">Proof of Exit Stamp from the UAE</div></div></div>';
     $('.applicantinfomation-0 .qualificationofapplicant').after(htmlcertifiate);  
   } 
   else if(conditionalcountry_flagsinng==1) 
   {
   ...
   //
    ...
    /*hotel register validation*/
        ...
        {
            console.log('-------------------------------')
            console.log('inside hotel booking condition');
            console.log('applicant no:'+loopcontroller);
            ...
            if(loopcontroller > 1){
              relationship      = $('.applicantinfo-1-relationship').siblings('.cs-placeholder').text();
            }else{
     ...
     if(relationtype=='Other' && (typeofregident=='UAE RESIDENT' || typeofregident=='NON UAE RESIDENT (WITH UAE REFERENCE)') && country_flag!='LIMITED' )
       ...
       if((typeofregident=='NON UAE RESIDENT (WITHOUT UAE REFERENCE)') && (country_flag=='LIMITED'))
        {
           console.log('non uae reside hotel reservation show- vivek');
       ...
       if((typeofregident=='NON UAE RESIDENT (WITHOUT UAE REFERENCE)') && (country_flag!='LIMITED'))
        {
           ...
           var restrict_country_limited = ["18","156","144","162"];
         //  countryassociated = $('.applicantno-0 select[name="applicantinfo[0][\'country\']"]').val();
          countryassociated = $("#orignalcountry").val();
           var checklimitedHas = restrict_country_limited.indexOf(countryassociated); 
          
          if(loopcontroller == 1 || relationtype=='Other')
             {
                  htmlcertifiate +='<div class="col-sm-4 qualificationcertificatecls fgg"><div class="file-wrap"><div class="c2c-file-upload mandatory '+qualitycertificationmandatorycls+' ">';
                  htmlcertifiate +='<input name="applicantinfo[0][qualificationcertificate]" type="file" />';
                  htmlcertifiate +='<img src="catalog/view/theme/theme_c2c/images/attachmnt-icon.svg"/></div><div class="file-text">Qualification Certificate</div></div></div>';
       ...
       else if((country_flag!='LIMITED') && (typeofregident=='NON UAE RESIDENT (WITH UAE REFERENCE)' || typeofregident=='UAE RESIDENT'))
        {
            console.log('inside qualification');
             $(".qualificationcertificatecls").remove();
           htmlcertifiate  ='';
           var restrict_country_limited = ["18","156","144","162"];
          // countryassociated = $('.applicantno-0 select[name="applicantinfo[0][\'country\']"]').val();
            countryassociated = $("#orignalcountry").val();
           var checklimitedHas = restrict_country_limited.indexOf(countryassociated); 
          console.log('qualification mandatory :'+qualitycertificationmandatorycls);
          console.log('check limit:'+checklimitedHas);
          if(loopcontroller == 1 || relationtype=='Other')
             {
                  console.log('relation type inside');
                  if(relationtype=='Other'){
                    qualitycertificationmandatorycls='mandatory';
                  }else{
                    qualitycertificationmandatorycls='';
                  }
                  if(checklimitedHas!=-1 && relationtype!='Other'){
                    htmlcertifiate +='<div class="col-sm-4 qualificationcertificatecls fgg"><div class="file-wrap"><div class="c2c-file-upload '+qualitycertificationmandatorycls+' ">';
                    htmlcertifiate +='<input name="applicantinfo[0][qualificationcertificate]" type="file" />';
                    htmlcertifiate +='<img src="catalog/view/theme/theme_c2c/images/attachmnt-icon.svg"/></div><div class="file-text">Qualification Certificate</div></div></div>';
                    $('.applicantinfomation-0 .qualificationofapplicant').after(htmlcertifiate);
                  }
       ...
       if(country_flag!='LIMITED')    
          {
            ...
            countryassociated = $("#orignalcountry").val();
            var checklimitedHas = restrict_country_limited.indexOf(countryassociated); 
            $(".marriage_certificate").hide()
            
            if(checklimitedHas!=-1)
              {
                $(".marriage_certificate").show();
              }
          }
    ...
    for(ilopp=1; ilopp<loopcontroller;ilopp++)
    {
        ...
        if(typeofregident=='UAE RESIDENT' || typeofregident=='NON UAE RESIDENT (WITH UAE REFERENCE)')
        {
           ...
           // relationship      = $('.applicantno-'+ilopp+' select[name="applicantinfo['+ilopp+'][\'relationship\']"]').val();
            relationship      = $('.applicantinfo-'+ilopp+'-relationship').siblings('.cs-placeholder').text();
            console.log('country selected:'+countryassociated);
            console.log('loop relation ship:'+relationship);
            if(relationship=='Other' && country_flag=='LIMITED')
            {
       ...
       // applcantresidence       = $('div.applicantinfo-'+ilopp+'-residence span.cs-placeholder').text();
        ...
        applcantresidence       = $('select[name="applicantinfo['+ilopp+'][residence]"]').select2('data')[0]['text'];
        console.log('applicant residence:'+applcantresidence);
        ...
        applcantcountrytext     = $('select[name="applicantinfo['+ilopp+'][country]"]').select2('data')[0]['text'];        
        ...
        console.log('---------------------------');
        console.log('relation ship latest:'+relationship);
        console.log('country flag latest:'+conditionalcountry_flag);
        console.log('type of resident:'+typeofregident);
        console.log('conditional country flag sign:'+conditionalcountry_flagsinng);
        if( (relationship=='Other' || conditionalcountry_flag==1) && (typeofregident=='NON UAE RESIDENT (WITHOUT UAE REFERENCE)'))
        {
          console.log('iside non uae with conditional country and others');
          //$('.applicantinfomation-'+ilopp+' .hotelreservation').remove();
           /*
        ...
        if((conditionalcountry_flagsinng==1) && (typeofregident=='NON UAE RESIDENT (WITHOUT UAE REFERENCE)')) 
           {
              console.log('non uae without reference all matching');
              if(relationship!='Other'){
                console.log('relation ship is other');
                $('.applicantinfomation-0 .exitstampcls').remove();
                $('.applicantinfomation-'+ilopp+' .exitstampcls').remove();
              }

              //$('.applicantinfomation-'+ilopp+' .qualificationcertificatecls').remove();
              $(".exitstampcls").remove();
              htmlcertifiate  ='';
              htmlcertifiate +='<div class="col-sm-4 qualificationcertificatecls fgg"><div class="file-wrap"><div class="c2c-file-upload mandatory '+qualitycertificationmandatorycls+' ">';
              htmlcertifiate +='<input name="applicantinfo[0][qualificationcertificate]" type="file" />';
              htmlcertifiate +='<img src="catalog/view/theme/theme_c2c/images/attachmnt-icon.svg"/></div><div class="file-text">Qualification Certificate</div></div></div>';
              //applhtml += '<div class="col-sm-4 exitstampcls"><div class="file-wrap"><div class="c2c-file-upload mandatory"><input name="applicantinfo[0][exitstamp]" type="file"><img src="catalog/view/theme/theme_c2c/images/attachmnt-icon.svg"></div><div class="file-text">Proof of Exit Stamp from the UAE</div></div></div>';
             $('.applicantinfomation-0 .qualificationofapplicant').after(htmlcertifiate);  
             console.log('last changes 2 -vivek');
           } 
           else if(conditionalcountry_flagsinng==1) 
           {
              console.log('adding qualification for conditional country');
              $(".qualificationcertificatecls").remove();
              htmlcertifiate  ='';
              applhtml +='<div class="col-sm-4 qualificationcertificatecls fgg"><div class="file-wrap"><div class="c2c-file-upload mandatory '+qualitycertificationmandatorycls+' ">';
              applhtml +='<input name="applicantinfo[0][qualificationcertificate]" type="file" />';
              applhtml +='<img src="catalog/view/theme/theme_c2c/images/attachmnt-icon.svg"/></div><div class="file-text">Qualification Certificate</div></div></div>';
             //$('.applicantinfomation-0 .qualificationofapplicant').after(htmlcertifiate);  

           }
          else if((conditionalcountry_flagsinng==0) && (typeofregident=='NON UAE RESIDENT (WITHOUT UAE REFERENCE)') && (relationship=='Other')) 
           {
            console.log('inside non uae resident with other condition');
            //  $(".qualificationcertificatecls").remove();
              htmlcertifiate  ='';
              applhtml +='<div class="col-sm-4 qualificationcertificatecls fgg"><div class="file-wrap"><div class="c2c-file-upload mandatory '+qualitycertificationmandatorycls+' ">';
              applhtml +='<input name="applicantinfo[0][qualificationcertificate]" type="file" />';
            ...
            console.log('inside my condition non uae resident');  
            $(".qualificationcertificatecls").remove();
           } 
          else if((country_flag!='LIMITED') && (typeofregident=='NON UAE RESIDENT (WITH UAE REFERENCE)' || typeofregident=='UAE RESIDENT'))
            {
                console.log('inside not limited with uae and non uae with reference');
               var restrict_country_limited = ["18","156","144","162"];
              // countryassociated = $('.applicantno-0 select[name="applicantinfo[0][\'country\']"]').val();
                countryassociated = $('.applicantno-'+ilopp+' select[name="applicantinfo['+ilopp+'][\'country\']"]').val();
               var checklimitedHas = restrict_country_limited.indexOf(countryassociated); 
              ...
              if(relationship=='Other')
                 {
                  ...
                  {
                      console.log('qualification certificates adding');
                      if(relationship=='Other'){                    
        ...
        applhtml +='</div>';
       // console.log(applhtml);
       /*
        applhtml +='<div class="col-sm-4"><div class="file-wrap"><div class="c2c-file-upload">';
         applhtml +='<input name="applicantinfo[0][marriage]" type="file" />';
         applhtml +='<img src="catalog/view/theme/theme_c2c/images/attachmnt-icon.svg"/></div><div class="file-text">Proof of Marriage Certificate(Nikkah Nama)</div></div></div>';
       ...
       */
        ...
        /*(function() {
          ...
          (function() {
            [].slice.call( document.querySelectorAll( '.applicantinfo-qualification-'+ilopp+' select.cs-select' ) ).forEach( function(el) {  
              new SelectFx(el,{
                ...
                console.log('inside change - vivek');

                if(nameofselepart[2]=='qualification]')
                {
                    console.log('inside qualification part');
                    counteronchange = $('select[name="'+nameofsele+'"]').attr('data-relnum');
                    var country_flag = $('input[name="country_flag"]').val();    
                    relationtype_latest = $('.applicantno-'+counteronchange+' .personrelationshipvisa .cs-placeholder').text();
                    console.log('country flag:'+country_flag);
                    console.log('relation ship latest:'+relationtype_latest);
                    if(country_flag=='LIMITED') /*14 30 without bangladash*/
                    {
                        console.log('inside limited condition');
                        if(relationtype_latest!='Other' && (val=='Diploma' || val=='High School' || val=='Does not apply'))
                         {
                            console.log('inside not other relation and low qualification');
                            $('.applicantinfomation-'+counteronchange+' .exitstampcls').remove();
                         }
                      else  if(val=='Diploma' || val=='High School' || val=='Does not apply' && relationtype_latest=='Other')
                        {
                            console.log('inside other relation and low qualification');
                        ...
                        {
                              console.log('inside higher qualification');
                    ...
                    {
                    console.log('inside all country condition');
                        /*now need to check bangldash,pak...etc */
                         ...
                         //alert("country:- "+applicantcountry);
                            ...
                            console.log('check limit:'+checklimitedHasforone);
                          // if(checklimitedHasforone==-1)
                           if(checklimitedHasforone==-1)
                           {                                                                                               
                                /*countrey not found so apply condion as like above*/
                               // $(".marriage_certificate").show();
                               console.log('country check successfully');
                              /* added by vivek*/
                               if(typeofregident=='UAE RESIDENT'){
                                  console.log('UAE RESIDENT');
                                  prfExitStmpCls = '';
                                  if((val=='Diploma' || val=='High School' || val=='Does not apply') && (relationtype!='Other')){

                                    /*$('.applicantinfomation-'+counteronchange+' .qualificationcertificatecls').addClass('hide');                                    
                                    htmladdcer = '<div class="col-sm-4 exitstampcls"><div class="file-wrap"><div class="c2c-file-upload"><input name="applicantinfo['+counteronchange+'][exitstamp]" type="file"><img src="catalog/view/theme/theme_c2c/images/attachmnt-icon.svg"></div><div class="file-text">Proof of Exit Stamp from the UAE</div></div></div>';
                                    $('.applicantinfomation-'+counteronchange+' .qualificationofapplicant').after(htmladdcer);*/
                                    
                                    ///new -vivek
                                   /* $('.applicantinfomation-'+counteronchange+' .qualificationcertificatecls').remove();
                                    htmladdcer  = '<div class="col-sm-4 qualificationcertificatecls fgg"><div class="file-wrap"><div class="c2c-file-upload"><input name="applicantinfo['+counteronchange+'][qualificationcertificate]" type="file"><img src="catalog/view/theme/theme_c2c/images/attachmnt-icon.svg"></div><div class="file-text">Qualification Certificate</div></div></div>';
                                    $('.applicantinfomation-'+counteronchange+' .qualificationofapplicant').after(htmladdcer);*/
                                    ...
                                    console.log('inside higher qualification');
                                    $('.applicantinfomation-'+counteronchange+' .exitstampcls').remove();
                                    $('.applicantinfomation-'+counteronchange+' .qualificationcertificatecls').removeClass('hide');
                                    $('.applicantinfomation-'+counteronchange+' .qualificationcertificatecls').remove();
                                    /*htmladdcer  = '<div class="col-sm-4 qualificationcertificatecls fgg"><div class="file-wrap"><div class="c2c-file-upload"><input name="applicantinfo['+counteronchange+'][qualificationcertificate]" type="file"><img src="catalog/view/theme/theme_c2c/images/attachmnt-icon.svg"></div><div class="file-text">Qualification Certificate</div></div></div>';
                                    $('.applicantinfomation-'+counteronchange+' .qualificationofapplicant').after(htmladdcer);*/
                               ...
                               if(typeofregident=='NON UAE RESIDENT (WITH UAE REFERENCE)'){
                                  console.log('none uae resident inside - vivek');
                                  if((val=='Diploma' || val=='High School' || val=='Does not apply')&&(relationtype!='Other')){
                                    console.log('not other inside');
                                    $('.applicantinfomation-'+counteronchange+' .qualificationcertificatecls').remove();
                                    $('.applicantinfomation-'+counteronchange+' .exitstampcls').remove();
                                    /*htmladdcer = '<div class="col-sm-4 exitstampcls"><div class="file-wrap"><div class="c2c-file-upload"><input name="applicantinfo['+counteronchange+'][exitstamp]" type="file"><img src="catalog/view/theme/theme_c2c/images/attachmnt-icon.svg"></div><div class="file-text">Proof of Exit Stamp from the UAE</div></div></div>';
                                      $('.applicantinfomation-'+counteronchange+' .qualificationofapplicant').after(htmladdcer);*/
                                    ...
                                    $('.applicantinfomation-'+counteronchange+' .exitstampcls').addClass('hide');
                                    $('.applicantinfomation-'+counteronchange+' .qualificationcertificatecls').removeClass('hide');
                                    $('.applicantinfomation-'+counteronchange+' .qualificationcertificatecls .c2c-file-upload').removeClass('mandatory');
                                    ///new vivek
                                    $('.applicantinfomation-'+counteronchange+' .exitstampcls').remove();
                                    $('.applicantinfomation-'+counteronchange+' .qualificationcertificatecls').remove();
                               ...
                               if(typeofregident=='NON UAE RESIDENT (WITHOUT UAE REFERENCE)'){
                                  console.log('iside non uae without ref');
                                  if((val=='Diploma' || val=='High School' || val=='Does not apply') && (relationtype=='Other')){
                                    $('.applicantinfomation-'+counteronchange+' .exitstampcls').remove();
                                    htmladdcer = '<div class="col-sm-4 exitstampcls"><div class="file-wrap"><div class="c2c-file-upload mandatory"><input name="applicantinfo['+counteronchange+'][exitstamp]" type="file"><img src="catalog/view/theme/theme_c2c/images/attachmnt-icon.svg"></div><div class="file-text">Proof of Exit Stamp from the UAE</div></div></div>';
                                    $('.applicantinfomation-'+counteronchange+' .qualificationofapplicant').after(htmladdcer);
                              ...
                              /* end vivek */
                               if((conditionalcountry_flagsinng==0) && (typeofregident=='NON UAE RESIDENT (WITHOUT UAE REFERENCE)') && (relationship=='Other'))  
                                {
                               ...
                               else
                               {
                                   ...
                                   if(typeofregident=='NON UAE RESIDENT (WITHOUT UAE REFERENCE)' )
                                     {
                                        console.log('no uae resident latest - vivek');
                                         if( (val=='Diploma' || val=='High School' || val=='Does not apply') && (relationtype!='Other'))
                                            {
                                           ...
                                           else if((val=='Diploma' || val=='High School' || val=='Does not apply')&&(relationtype=='Other'))
                                            {
                                              ...
                                              console.log('inside my condition non uae residents');
                                            }else if(val=='Bachelors' || val=='Masters' || val=='Phd')
                                            {
                                                  $('.applicantinfomation-'+counteronchange+' .qualificationcertificatecls').remove();
                                                  $('.applicantinfomation-'+counteronchange+' .exitstampcls').remove();
                          ...
                          console.log('my else part- vivek');
                          if( typeofregident == 'UAE RESIDENT' || typeofregident == 'NON UAE RESIDENT (WITH UAE REFERENCE)'){
                            console.log('inside uae resident condition');
                            if((val=='Diploma' || val=='High School' || val=='Does not apply') && (relationtype!='Other')){
                              $('.applicantinfomation-'+counteronchange+' .qualificationcertificatecls').addClass('hide');
                              $('.applicantinfomation-'+counteronchange+' .qualificationcertificatecls').remove();
                              htmladdcer  = '<div class="col-sm-4 qualificationcertificatecls fgg"><div class="file-wrap"><div class="c2c-file-upload mandatory  "><input name="applicantinfo['+counteronchange+'][qualificationcertificate]" type="file"><img src="catalog/view/theme/theme_c2c/images/attachmnt-icon.svg"></div><div class="file-text">Qualification Certificate</div></div></div>';
                          ...
                          if(typeofregident=='NON UAE RESIDENT (WITHOUT UAE REFERENCE)'){
                              console.log('inside non uae resident without uae resident');
                              if((val=='Diploma' || val=='High School' || val=='Does not apply') && (relationtype!='Other')){
                                $('.applicantinfomation-'+counteronchange+' .exitstampcls').remove();
                              }else if((val=='Diploma' || val=='High School' || val=='Does not apply') && (relationtype=='Other')){
                                $('.applicantinfomation-'+counteronchange+' .exitstampcls').remove();
         ...
         if(relationtype=='Other' && (typeofregident=='UAE RESIDENT' || typeofregident=='NON UAE RESIDENT (WITH UAE REFERENCE)') && country_flag!='LIMITED' )
           ...
           /*now you are in 3rd option*/
            /*now check  for # condion with **double star  */
            var new_country_flag = $('input[name="country_flag"]').val();    
            if(new_country_flag=='LIMITED')
            {
                /*this is for 14, 30 days pakage*/
                console.log('inside 14 and 30 days package- vivek'); 
               if(relationtype=='Other' && typeofregident=='NON UAE RESIDENT (WITHOUT UAE REFERENCE)'){
                    $('.applicantinfomation-'+ilopp+' .hotelreservation').addClass('show');  
                }
            }
            else
            {
                  /*this is for 90 days pakage*/
                  //$('.applicantno-0 input [name="applicantinfo[0][qualificationcertificate]"]').addClass('mandatory');
                  console.log('inside 90 days package - vivek');
                  $('.hotelreservation').addClass('hide');
                  if(conditionalcountry_flagsinng==1 && (typeofregident=='UAE RESIDENT' || typeofregident=='NON UAE RESIDENT (WITH UAE REFERENCE)')){
                    console.log('adding qualification for conditional country latest-vivek');
                    $('.applicantinfomation- .qualificationcertificatecls').remove();
    ...
    */
    ...
    userresidence = $('select[name="applicantinfo[0][residence]"]').select2('data')[0]['text'];
   // usercountry         = $('.personcountryvisa .cs-placeholder').text();
    usercountry         = $('select[name="applicantinfo[0][country]"]').select2('data')[0]['text'];
