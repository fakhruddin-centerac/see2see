                  ...
                  <div class="modal-content" id="product">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="inputgropcus">
                            <input <?php echo $attr; ?>type="text" class="numberofhourls" onkeyup="numbetofhoursc(this.value,<?php echo $product['options'][0]['option_id']; ?>)" for="numberofhourls" name="parenthidprice" placeholder="Enter No. of Hours"  />    
                        </div>
                        <div class="book-location customfiledslimo">
                                <span>
                                    <i class="fa fa-calendar" aria-hidden="true"></i>
                                    <input type="text" onblur="chkvaldation(this.val)" name="tourdate" id="datepicker" class="choose-location-book" placeholder="Date"/>
                                </span>
                                <span>
                        ...
                        {
                        ?>
                        <input type="hidden" name="tourdate" value="1" />
...
$('.button-cartcusvivi').on('click', function() { 
    $.ajax({
        ...
        data: $('.in #product input[type=\'hidden\'],.in .inputgropcus .numberofhourls,.customfiledslimo input'),
		dataType: 'json',
		beforeSend: function() {
