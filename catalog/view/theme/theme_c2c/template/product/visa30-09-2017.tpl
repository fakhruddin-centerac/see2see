...
function addapplicanbut()
{
    ...
    html  ='<div class="review-block visa-main applicantno-'+applcannumber+'" id="fixedapplicantno-'+addcountercus+'"><div class="row visa-item"><div class="col-sm-12"><div class="visa-title"><h3>Applicant no '+ applcannumber +'</h3></div><div class="row"><div class="col-sm-4"><div class="select-drop mandatory">';
   ...
   html +='<select id="select_'+applcannumber+'" name="applicantinfo['+applcannumber+'][relationship]"  class="cs-select cs-skin-border applicantinfo-'+applcannumber+'-relationship testvkisdaa visaC_'+applcannumber+'" rel='+applcannumber+' ><option value=""disabled selected >Relationship with primary applicant</option><option value="father">Father</option><option value="mother">Mother</option><option value="spouse">Spouse</option><option value="brother">Brother</option><option value="sister">Sister</option><option value="Children">Children</option><option value="Other">Other</option></select></div></div>';  
    ...
    html +='</div><div class="addmoreblock "><div class="addmore" onclick="addapplicanbut()">Add More Applicant</div><div class="removeele" onclick="removeapplicanbut('+applcannumber+') ">Remove Applicant</div></div></div></div></div></div>';
   ...
   loopRun = $("#number_of_applicant").val();
              ...
              $('#visa-1 .mandatory input').each(function(){
                ...
                {    
                    ...
                    {
                        var msg = "<div class='alert alert-danger fade in'><a href='#' class='close' data-dismiss='alert'>&times;</a><strong>Sorry</strong> we didn't give the visa to this country</div>";
                        $('.section-list-inner .msgpart').html(msg);
                        $('html, body').animate({ scrollTop: 300 }, 'slow');
                    }
                    return true;
 ...
 function nextTab(elem) 
 {
    ...
    for(ilopp=1; ilopp<loopcontroller;ilopp++)
    {
        ...
        */
        ...
        applhtml +='<div class="col-sm-6"><div class="travl-mob"><div class="apli-sub">Travellers Mobile No.</div>';
