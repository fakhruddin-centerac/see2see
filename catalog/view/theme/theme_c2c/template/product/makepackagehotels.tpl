        ...
        <div class="side-panel">
            <div class="side-panel-box">
                <div class="hotel-form-main">
                    <form class="home-hotel-form" name="hotel-search" id="hotel-search" action="<?php echo 'index.php?route=product/makepackage/hotels'; ?>" method="post">
                        <h2>MODIFY SEARCH</h2>                        
                    ...
                    <div class="hotel-result-container">
                        <div class="hotel-search-box">
                            ...
                            <div class="hotel-info">
                                <h2><a href="<?php echo 'index.php?route=product/makepackage/packagedetails&hotel_id='.$hotel_id.'&package_id='.$package_id.'&star_rating='.$filter_star.'&total_people='.$total_people.'&filter='.$filter_nationality.'&filter_room='.$filter_rooms.'&filter_adult='.$filter_adult.'&filter_child='.$filter_child.'&checkin='.$filter_checkin.'&checkout='.$filter_checkout.'&visa_option='.$filter_visa.'&transfer_option='.$filter_transfer; ?>"><?php echo $hotel['name']; ?></a></h2>
